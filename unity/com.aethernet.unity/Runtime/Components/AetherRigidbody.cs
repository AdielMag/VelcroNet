...
namespace AetherNet
{
    ...
    public sealed class AetherRigidbody : MonoBehaviour
    {
        ...
        /// <summary>Called once by AetherViewManager after the world is created.</summary>
        ...
        // ─── Interpolation (called by AetherViewManager) ─────────────────────
        ...
        /// <summary>
        /// Push the interpolated transform to Unity. Called from AetherViewManager.LateUpdate.
